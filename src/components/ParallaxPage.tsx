...
- Children without a numeric zIndex prop sort to the bottom (treated as 0).
  */
  ...
  const zA = isValidElement(a) && typeof (a.props as { zIndex?: number }).zIndex === 'number' ? (a.props as unknown as { zIndex: number }).zIndex : 0;
  const zB = isValidElement(b) && typeof (b.props as { zIndex?: number }).zIndex === 'number' ? (b.props as unknown as { zIndex: number }).zIndex : 0;
  return zA - zB;
  });
  }
...
<div style={{ ...viewportStyle, ...cssVars }}
